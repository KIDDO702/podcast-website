<div>
    <form wire:submit.prevent="submit">
        <div>
            <input type="text" placeholder="Admin" wire:model='name' class="w-full bg-gray-50 border border-slate-200 rounded-sm px-4 py-2 focus:outline focus:outline-slate-400 focus:outline-offset-2">
            @error('name')
